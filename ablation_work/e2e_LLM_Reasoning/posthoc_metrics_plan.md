...
The primary paired inference must be **GPT-4o-mini Base versus CoT**, the only
complete 500/500 prompt pair. The other models are useful descriptive evidence
only because at least one paired condition failed or is incomplete.
...
| GLM-5 | 482 / 500 | 437 / 500 | Descriptive only; heavy differential attrition |
| Qwen3-8B | 382 / 500 | 500 / 500 | Descriptive only; Base failures dominate |
