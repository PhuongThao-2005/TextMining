...
2026-09-10. The refreshed files complete the DeepSeek-V3.1-Thinking, GLM-5,
and Qwen3-8B Base/CoT pairs. The DeepSeek Base directory is normalized to
`deepseekv3.1-thinking-base`; its repaired CoT run now evaluates all 500
questions. The Qwen CoT artifact is manifest-backed and identifies
`qwen3-8b`.
...
| DeepSeek-V3.1-Thinking | CoT | `deepseekv3.1-thinking-CoT` | 500 | 0 | 0.2225 | 0.1651 | 0.1412 | 0.922 | 20.59 s |
...
- DeepSeek Base/CoT is now complete at 500/500, with four exact top-10 chunk-ID
  sequence differences among the 500 shared successful cases (likely tied-score
