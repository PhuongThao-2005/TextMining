...
isolates four component choices using fixed question sets and paired metrics.
...
The central lesson is that component labels are not outcomes. Hybrid, graph,
CoT, and cited output are not quality guarantees. Candidate control and paired
question-level deltas reveal effects obscured by aggregate scores: graph
expansion increases density while removing evidence, and rerankers can only
improve what has entered C30. Frozen manifests and complete row alignment are
essential before interpreting a difference as causal.
