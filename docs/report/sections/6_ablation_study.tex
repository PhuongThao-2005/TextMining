...
\texttt{report\_structure.md}. We report five completed experiment families
and retain the deterministic evidence available for each one. Comparisons are
made within a family because candidate construction and context budgets differ;
...
Hybrid retrieval adds BM25 and reciprocal rank fusion. DenseOnly outperforms
...
from 5.483 seconds to 31.538 seconds; paired uncertainty is reported in
...
questions; latency percentiles use all 500 cases.}
...
\textbf{Total p50/p95} \\
\midrule
DenseOnly & 0.3678 & 0.4855 & 0.2267 & 0.2813 & 0.797/0.856 & 5.483/9.946 \\
HybridOnly & 0.3140 & 0.4257 & 0.2252 & 0.2638 & 27.855/27.924 & 31.538/33.623 \\
\bottomrule
\end{tabular}%
}
\end{table*}
...
chunks. Graph expansion currently displaces more evidence than it adds.
...
graph-missed gold was present before expansion but absent afterward.}
...
1 query (0.25\%) & 61 queries (15.25\%) & 5.605 & 0.0800 \\
HybridOnly $\rightarrow$ HybridGraph & $-0.1181$ & $-0.0240$ & $-0.0411$ &
6 queries (1.50\%) & 59 queries (14.75\%) & 6.305 & 0.0641 \\
\bottomrule
\end{tabular}%
}
\end{table*}
...
BM25 precomputation cost of about 13,495 seconds and a much larger per-query
retrieval cost. Among rerankers, mMiniLM is fastest, Jina is intermediate,
...
The completed evidence supports conditional engineering decisions. Metadata
